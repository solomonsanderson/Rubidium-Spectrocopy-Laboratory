...
def plot_hyperfine(hypefine_path, no_hyperfine_path, ax, ax_original=None):
...
if __name__ == "__main__":
    ...
    hyperfine_path = "scope_captures\scope_105.csv"
    no_hyperfine_path ="scope_captures\scope_106.csv"
    fig, ax = plt.subplots()
    # plot_hyperfine(hyperfine_path, no_hyperfine_path, ax)
